...
public class HistoryPaneController2 implements GenericFileReadWriteAware {
	private static final Logger logger = LogManager.getLogger(HistoryPaneController2.class);

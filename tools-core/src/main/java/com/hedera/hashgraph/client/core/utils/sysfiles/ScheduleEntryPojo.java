...
public class ScheduleEntryPojo {
    ...
    public static ScheduleEntryPojo fromProto(TransactionFeeSchedule grpc) {
        ...
        for (FeeData feeData : grpc.getFeesList()) {
            ...
            var nodePrices = ResourcePricesPojo.fromProto(feeData.getNodedata());
            var servicePrices = ResourcePricesPojo.fromProto(feeData.getServicedata());
            var networkPrices = ResourcePricesPojo.fromProto(feeData.getNetworkdata());

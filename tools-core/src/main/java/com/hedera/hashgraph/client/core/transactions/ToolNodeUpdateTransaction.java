...
public class ToolNodeUpdateTransaction  extends ToolTransaction {
    ...
    public ToolNodeUpdateTransaction(final File inputFile) throws HederaClientException {
        ...
        this.declineReward = ((NodeUpdateTransaction) transaction).getDeclineReward();
    ...
    public Transaction<?> build() throws HederaClientRuntimeException {
        ...
        if (declineReward != null) {
            nodeUpdateTransaction.setDeclineReward(declineReward);
        }
    ...
    public boolean equals(final Object obj) {
        if (!super.equals(obj) || !(obj instanceof ToolNodeUpdateTransaction)) {
            return false;
        }

        final var other = (ToolNodeUpdateTransaction) obj;
        return this.dabNodeId == other.dabNodeId &&
                Objects.equals(this.dabNodeAccountId, other.dabNodeAccountId) &&

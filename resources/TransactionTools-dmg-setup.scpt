tell application "Finder"
  tell disk "TransactionTools"
    ...
    repeat with theFile in allTheFiles
      ...
      if theFilePath is "/TransactionTools.app" then
      -- Position application location
        set position of item theFile of container window to {120, 15}
      else if theFilePath is "/Applications" then
      -- Position install location
        set position of item theFile of container window to {390, 15}
      else
